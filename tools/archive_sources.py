...
def source_bytes(name):
    # Text sources use LF in Git, independently of a local editor's line endings.
    return (P/name).read_bytes().replace(b'\r\n',b'\n')
